...
import { fillBlankData } from '../../data/gameData';

export default function FillBlankGame({ navigation, route }) {
  ...
  const questions = fillBlankData[difficulty] || fillBlankData.beginner;
  ...
  if (!gameStarted) {
    return (
      <View style={styles.container}>
        <LinearGradient colors={['#A8E6CF', '#88D8A3', '#6BCB9F']} style={styles.startScreen}>
          ...
          <Text style={styles.startHint}>Hãy chọn từ đúng để điền vào chỗ trống nhé! 🌟</Text>
  ...
  return (
    <View style={styles.container}>
      <LinearGradient colors={['#A8E6CF', '#88D8A3']} style={styles.header}>
      ...
      <View style={styles.content}>
        ...
        <View style={styles.optionsContainer}>
          <Text style={styles.optionsLabel}>🔤 Chọn từ đúng:</Text>
